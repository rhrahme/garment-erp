...
export const PRINT_SEWING_A4_FROM_PATTERN_HOWTO_BODY = [
  ...
  "   - On the client pattern sheet: tap Print production (indigo).",
  "   - On the print page: tap Production (tabs are Cutter | Production | Sewing).",
  "   - Sewing A4s if you need to tick which fabrics, then open the preview.",
  "   - Or on the order board: tick fabrics, choose Production, Print selected.",
  ...
  "5. Size 52 check.",
  "6. Client pattern sheet: Print production (indigo). Print page: Production tab.",
  "   Sewing A4s hole fabric tick. Order board: tick -> Production -> Print selected.",
...
export const WALL_ATTENDANCE_QR_HOWTO_V3_BODY = [
  ...
  "The wall poster is already hung. Scan it. Do not print another copy.",
  "Tablet camera: Stitch kiosk -> Use tablet camera. Gun scanner still works.",
  "",
  "BANGLA",
  "Attendance entrance e. Eita piece start kore na.",
