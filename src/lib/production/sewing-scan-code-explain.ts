...
export function explainUnrecognizedStitchScan(raw: string): string {
  ...
  return (
    ...
    "Stitch accepts EMP / EMPALT / EMPIRON / EMPBTN / EMPWASH / EMPHOLE / EMPBST / EMPCHMP / EMPBART badge QRs, the Attendance wall QR (ATTEND or HAGAN-HERE), or production A4 piece QR " +
