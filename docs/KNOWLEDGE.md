...
- **Attendance means the wall QR** (Sep 8 2026): when the owner says
  ...
  time, or Production Floor now. Stitch kiosk -> **Attendance**
  (next to History) is **view only** for every stitch login:
  Entered / Left / No entry. Nobody edits door times there.
  **Print** and the piece Open detail stay **admin only**.
  They still scan badge + wall QR on Scan.
...
- **Morning attendance wall QR** (Sep 7 2026): official payload `ATTEND`
  ...
  **Entered** and **Left**, e.g. `Entered 07:42` / `Left 17:05`.
  ...
  any job (Mahmudul, Mohtajul, Hossain, Farid, and the rest).
  Saudis stay off. Reprint and piece Open stay admin only.
...
- **Top 1/2 Waist never lands on Trouser** (Aug 22 2026): same ownership
  ...
  (`1-2-waist-relux`). This is site-wide piece ownership, not a Khaled
...
- **Cost hint worksheet** (Sep 7 2026, details Sep 8): admin-only
