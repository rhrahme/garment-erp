/** Copy/format page JSON: node scripts/save-page-file.mjs <listId> <page> <src.json> */
import fs from "fs";
...
if (!listId || pageStr === undefined || !src) {
  console.error("Usage: save-page-file.mjs <listId> <page> <src.json>");
  process.exit(1);
}
