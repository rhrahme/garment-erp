...
echo "  Integrations: ERP_API_KEY, ZAPIER_WEBHOOK_URL, SMTP_*, IMAP_*, TRACK17_API_KEY, CLICKUP_API_TOKEN"
echo "  TRACK17 only: ./scripts/set-vercel-track17-env.sh --deploy"
