...
assert("not configured when env missing", !isFabricPriceUnlockConfigured());
assert("1122 invalid when env missing", !isFabricPriceAccessCodeValid("1122"));
...
assert("1122 invalid with only invoice password", !isFabricPriceAccessCodeValid("1122"));
