#!/usr/bin/env node
/**
 * Restore Moussa SO-2026-0109 line 8 (43293/160): Shirt+Trouser+Short, 3 labels.
 */
...
const GARMENT_TYPE = "Shirt+Trouser+Short";
const LABEL_COUNT = 3;
...
async function main() {
  ...
  if (order.notes?.includes("43293/160: Fabric only")) {
