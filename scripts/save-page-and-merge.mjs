/** Save filter page + merge summaries: node save-page-and-merge.mjs <listId> <page> < stdin */
import fs from "fs";
...
console.log(`Page ${pagePath} (${payload.count ?? 0}) → summaries ${Object.keys(map).length}`);
